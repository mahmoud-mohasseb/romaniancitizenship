  ...
  const navGroups = [
    ...
    },
    {
      ...
      links: [
        ...
        { href: '/records', label: appLang === 'ar' ? 'التسجيلات والتفريغ الصوتي 🎙️' : appLang === 'en' ? 'Audio Records & Transcripts 🎙️' : 'Înregistrări Audio & Transcriere 🎙️', sub: appLang === 'ar' ? 'مشغل Spotify والتفريغ المباشر' : appLang === 'en' ? 'Spotify player & audio transcripts' : 'Player Spotify & transcrieri audio', icon: Music, color: 'text-[#1DB954]' },
