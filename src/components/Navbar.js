...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { href: '/anc-info', label: appLang === 'ar' ? 'إجراءات ومستندات ANC 🏛️' : appLang === 'en' ? 'ANC Official Procedures 🏛️' : 'Proceduri Oficiale ANC 🏛️', sub: appLang === 'ar' ? 'قانون 21/1991 والمستندات والخطوات وقسم اليمين' : appLang === 'en' ? 'Law 21/1991, Dossier & Oath' : 'Legea 21/1991, Dosar & Jurământ', icon: ShieldCheck, color: 'text-amber-400' },
