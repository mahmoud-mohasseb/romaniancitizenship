...
export const UI_STRINGS = {
  ar: {
    ...
    appSubtitle: 'دليلك المتكامل لاجتياز الاختبار الشفهي للجنسية الرومانية وتعلم الأبجدية والنطق الصحيح والمحادثات اليومية',
    homeNav: 'الرئيسية',
    studyNav: 'المذاكرة',
    quizNav: 'الاختبارات',
    ...
    youtubeTitle: 'قنوات يوتيوب لتعلم الجنسية واللغة 📺',
    youtubeSubtitle: 'مكتبة مصنفة من أفضل قنوات اليوتيوب لتعلم اللغة الرومانية والتحضير للمقابلة',
  ...
  en: {
    ...
    appSubtitle: 'Comprehensive guide for Romanian Citizenship oral interview, alphabet, conversations, & channels',
    homeNav: 'Home',
    studyNav: 'Study',
    quizNav: 'Quizzes',
    ...
    youtubeTitle: 'YouTube Channels for Learning 📺',
    youtubeSubtitle: 'Categorized YouTube channels for Romanian citizenship prep & language learning',
  ...
  ro: {
    ...
    appSubtitle: 'Ghid complet pentru interviul de cetățenie, alfabetul român, conversații și canale YouTube',
    homeNav: 'Acasă',
    studyNav: 'Studiu',
    quizNav: 'Teste',
    ...
    youtubeTitle: 'Canale YouTube pentru Învățare 📺',
    youtubeSubtitle: 'Canale YouTube categorisite pentru pregătire cetățenie și învățarea limbii',
