...
export default function HomePage() {
  const [appLang, setAppLang] = useState('ar'); // Default Main Language AR
      ...
      <main className={`flex-1 w-full max-w-4xl mx-auto px-4 py-6 space-y-6 ${isRtl ? 'rtl' : 'ltr'}`} dir={isRtl ? 'rtl' : 'ltr'}>
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="bg-slate-800/80 rounded-2xl p-4 text-center border border-slate-700/60 flex flex-col items-center justify-center">
            ...
            <span className="text-[11px] text-slate-400 mt-1">حرفاً وأمصلة</span>
          </div>
        ...
        {/* Alphabet & Language Learning Cards Banners */}
